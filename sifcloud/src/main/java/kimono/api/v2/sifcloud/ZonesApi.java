...
public class ZonesApi {
     ...
     * @return java.util.List&lt;SIFZone&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public java.util.List<SIFZone> listZones() throws ApiException {
        ApiResponse<java.util.List<SIFZone>> resp = listZonesWithHttpInfo();
        return resp.getData();
    }
     ...
     * Get SIF Zones
     * Get a list of &#x60;SIFZone&#x60;s
     * @return ApiResponse&lt;java.util.List&lt;SIFZone&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<java.util.List<SIFZone>> listZonesWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = listZonesValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<java.util.List<SIFZone>>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call listZonesAsync(final ApiCallback<java.util.List<SIFZone>> callback) throws ApiException {
