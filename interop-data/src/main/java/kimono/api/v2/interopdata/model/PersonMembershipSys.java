...
public class PersonMembershipSys {
  public static final String SERIALIZED_NAME_$_SYS = "$sys";
  @SerializedName(SERIALIZED_NAME_$_SYS)
  private PersonMembershipRefType $sys = null;

  public PersonMembershipSys $sys(PersonMembershipRefType $sys) {
    this.$sys = $sys;
    return this;
  }
  ...
  **/
  ...
  public PersonMembershipRefType get$Sys() {
    return $sys;
  }

  public void set$Sys(PersonMembershipRefType $sys) {
    this.$sys = $sys;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PersonMembershipSys personMembershipSys = (PersonMembershipSys) o;
    return Objects.equals(this.$sys, personMembershipSys.$sys);
  }
  ...
  public String toString() {
    ...
    sb.append("class PersonMembershipSys {\n");
