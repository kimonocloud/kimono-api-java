...
public class IngestionsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listIngestionsCall(Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listIngestionsValidateBeforeCall(Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listIngestionsCall(page, pageSize, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public IngestionsResponse listIngestions(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<IngestionsResponse> resp = listIngestionsWithHttpInfo(page, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<IngestionsResponse> listIngestionsWithHttpInfo(Integer page, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = listIngestionsValidateBeforeCall(page, pageSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listIngestionsAsync(Integer page, Integer pageSize, final ApiCallback<IngestionsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listIngestionsValidateBeforeCall(page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<IngestionsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
